...
/**
 *       \file       htdocs/admfincas/ajax/admfinca.php
 *       \brief      File to return Ajax response on admfinca list request
 */
...
// Security check
if (!$user->hasRight('admfincas', 'admfinca', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax admfincas/ajax/admfinca.php");
