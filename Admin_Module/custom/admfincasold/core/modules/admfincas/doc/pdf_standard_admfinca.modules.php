...
/**
 *  \file       core/modules/admfincas/doc/pdf_standard.modules.php
 *  \ingroup    admfincas
...
/**
 *	Class to manage PDF template standard_admfinca
 */
class pdf_standard_admfinca extends ModelePDFAdmfinca
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	Admfinca	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('ADMFINCAS_DRAFT_WATERMARK') && $object->status == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('ADMFINCAS_DRAFT_WATERMARK')));
		}
