...
/**
 *  \file       admfinca_contact.php
 *  \ingroup    admfincas
 *  \brief      Tab for contacts linked to Admfinca
 */
...
$title = $langs->trans("Admfinca") . " - " . $langs->trans('ContactsAddresses');
//$title = $object->ref." - ".$langs->trans('ContactsAddresses');
$help_url = '';
//$help_url='EN:Module_Third_Parties|FR:Module_Tiers|ES:Empresas';
llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-admfincas page-card_contact');
